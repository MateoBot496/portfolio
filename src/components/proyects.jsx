        ...
        <section className="proyects" id="proyects">
            ...
            <div className="proyectosGrid" >
                ...
                <a href="https://mateoshopcart.netlify.app/">
                    <div className="proyectbox p1 " ref={(el) => proyects.current[1] = el}>
                    <p>SHOPPING CART</p>
                    </div>
                </a>
                <a href="https://mateobot496.github.io/singup_form/">
                    <div className="proyectbox p2" ref={(el) => proyects.current[2] = el}>
                    <p>SIGN-UP FORM</p>
                    </div>
                </a>
                <a href="https://mateobot496.github.io/calculator/">
                    
                    <div className="proyectbox p3" ref={(el) => proyects.current[3] = el}>
                    <p>CALCULATOR</p>
                    </div>
                </a>
                <a href="https://mateobot496.github.io/restaurant/">
                    <div className="proyectbox p4" ref={(el) => proyects.current[4] = el}>
                    <p>RESTAURANT</p>
                    </div>
                </a>
                <a href="https://mateobot496.github.io/weather-app/">
                    <div className="proyectbox p5 " ref={(el) => proyects.current[5] = el}>
                    <p>WEATHER APP</p>
                    </div>
                </a>
            </div>
